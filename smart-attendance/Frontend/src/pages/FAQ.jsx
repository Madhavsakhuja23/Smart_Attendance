export default function FAQ() {
    const faqs = [
        {
            q: "How does Smart Attendance work with Google Sheets?",
            a: "Smart Attendance uses a Google Sheets Editor Add-on that links your spreadsheet to our web platform. When you trigger attendance or fetch rosters from the web app, commands are passed to the Add-on running inside your Sheet."
        },
        {
    ...
    return (
        <div className="legal-page">
            <div className="legal-container">
                ...
                <p className="subtitle">Find quick answers to common questions about Smart Attendance.</p>
                ...
                <div className="faq-list" style={{ marginTop: "25px" }}>
                    {faqs.map((faq, index) => (
                        <div key={index} className="faq-item" style={{ marginBottom: "20px", padding: "18px", background: "rgba(255,255,255,0.03)", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.08)" }}>
                            ...
                            <p style={{ color: "#aaa", margin: 0 }}>{faq.a}</p>
                        </div>
                    ))}
                </div>
            </div>
